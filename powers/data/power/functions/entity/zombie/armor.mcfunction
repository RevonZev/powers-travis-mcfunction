...
replaceitem entity @a[tag=power.zombie] armor.legs minecraft:leather_leggings{display:{color:6192150}}
replaceitem entity @a[tag=power.zombie] armor.feet minecraft:leather_boots{display:{color:6192150}}