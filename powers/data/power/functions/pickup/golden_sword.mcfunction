...
#region punch detect
execute as @a[nbt={SelectedItem:{id:"minecraft:golden_sword",tag:{Power:1b}}}] at @s positioned ~ ~1 ~ unless entity @e[type=minecraft:slime,tag=power.punchDetect,distance=..2] run summon minecraft:slime ~ ~ ~ {Size:2,Tags:[power.punchDetect],NoAI:1b,ActiveEffects:[{ShowParticles:0b,Duration:1000000,Id:14}]}
